...
sed -i {s/TagXX/${mytag}/g} splitExtendedPhaseIPixelDatabase.sh
...
# GeometryExtendedPhaseIPixel_cff                       geSingleBigFile.xml
cmsRun geometryExtendedPhaseIPixel_xmlwriter.py
...
cmsRun geometryExtendedPhaseIPixel_writer.py
...
./splitExtendedPhaseIPixelDatabase.sh
